...
export class Form extends Component<FormProps, FormState> {
    ...
    onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const { isValid, error } = this.validateSync(this.state.value);
     ...
     * throttled for perf
     */
    validate: (value: FormValue) => void = throttle(value => {
        const formSchema = object().shape(this.validator);
    ...
    /**
     * Validate form using objectschema generated by `renderFields`
     * Synchronous to validate just before submit
     */
    validateSync(value): { isValid: boolean; error?: Object } {
        const formSchema = object().shape(this.validator);
        const ret = { isValid: false, error: null };

        try {
            formSchema.validateSync(value, { abortEarly: false });
            ret.isValid = true;
        } catch (validationErrors) {
            ret.error = this.getValidationState(validationErrors);
        }
