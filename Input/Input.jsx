...
export class Input extends Component {
    ...
    render() {
        const { value, prefix = null, label, isFetching, help, spellCheck, containerClass, className, type, disabled, block, large, size, icon, maxLength, autoFocus, autoComplete, errors, skipDateFormat, ...rest } = this.props;
