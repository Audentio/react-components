...
export class OverlayTrigger extends Component {
    ...
    render() {
        ...
        return (<Fragment>
                ...
                {visible &&
            ReactDOM.createPortal(<div ref={this.overlayMount} style={containerStyle}>
                            {overlay}
                        </div>, this.getOverlayNode())}
...
//# sourceMappingURL=OverlayTrigger.jsx.map